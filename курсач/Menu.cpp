    ...
    while (true) {
        ...
        if (menu_choice >= 1 && menu_choice <= 10) {
            ...
            case 4: {
                ...
                switch (sort_choice) {
                case 1: sort_success = current_family->sortRecords(SortField::DATE, true); break;
                case 2: sort_success = current_family->sortRecords(SortField::DATE, false); break;
                case 3: sort_success = current_family->sortRecords(SortField::CATEGORY, true); break;
                case 4: sort_success = current_family->sortRecords(SortField::CATEGORY, false); break;
                case 5: sort_success = current_family->sortRecords(SortField::AMOUNT, true); break;
                case 6: sort_success = current_family->sortRecords(SortField::AMOUNT, false); break;
                case 7: sort_success = current_family->sortRecords(SortField::USER, true); break;
                case 8: sort_success = current_family->sortRecords(SortField::USER, false); break;
            ...
            case 5: {
                ...
                if (search_choice == 1) {
                    ...
                    current_family->FindByDate(search_date);
                }
                else if (search_choice == 2) {
                    std::string search_category = ReadLine("Введите категорию: ");
                    current_family->FindByCategory(search_category);
                }
                else {
